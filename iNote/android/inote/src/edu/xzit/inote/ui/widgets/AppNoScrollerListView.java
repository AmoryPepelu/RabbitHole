...
public class AppNoScrollerListView extends ListView {
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (Math.abs(xDiff) > mTouchSlop && !mIsBeingHorizonalScrooled
					&& whichVerticalScrollFirst == -1) {
			...
			if (yDiff > mTouchSlop && !mIsBeingVerticalScrooled
					&& whichVerticalScrollFirst == -1) {
		...
		if (action == MotionEvent.ACTION_MOVE && !mIsBeingVerticalScrooled
				&& mIsBeingHorizonalScrooled && !hasDispatched
	...
	public void setOnHorizonalTouchEventListener(
			OnHorizonalTouchEventListener onHorizonalTouchEventListener) {
